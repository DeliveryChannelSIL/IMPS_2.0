...
/**
 * The persistent class for the D009027 database table.
 * 
 */
@Entity
@Table(name="D009027")
public class OffsetIntTD implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private OffsetIntTDId id;
	...
	@Column(name="IntOffset")
	private double intOffset;

	public OffsetIntTD() {
	}

	public OffsetIntTDId getId() {
		return this.id;
	}

	public void setId(OffsetIntTDId id) {
		this.id = id;
	}
