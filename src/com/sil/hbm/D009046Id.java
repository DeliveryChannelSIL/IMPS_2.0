 ...
 */
@Embeddable
public class D009046Id implements java.io.Serializable {
	...
	public D009046Id(int lbrCode, String prdAcctId, Date effFromDate) {
	...
	@Column(name = "DpDate", nullable = false, length = 23)
