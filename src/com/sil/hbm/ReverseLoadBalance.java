...
*/
@Entity
@Table(name = "REVERSE_LOAD_BALANCE")
@DynamicInsert
@DynamicUpdate
public class ReverseLoadBalance implements java.io.Serializable {
	...
	public ReverseLoadBalance() {
	}

	public ReverseLoadBalance(String rrn, Date entrydate, Date entrytime) {
		this.rrn = rrn;
		this.entrydate = entrydate;
		this.entrytime = entrytime;
	}

	public ReverseLoadBalance(String rrn, String accountno, Date entrydate, Date entrytime, Double amount,
