...
/**
 * D350036Id generated by hbm2java
 */
@Embeddable
public class D350036Id implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5109595176305849895L;
	private int lbrCode;
	...
	public D350036Id(int lbrCode, Date entryDate, String batchCd, int setNo, int scrollNo, Date entryTime) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof D350036Id))
			return false;
		D350036Id castOther = (D350036Id) other;
