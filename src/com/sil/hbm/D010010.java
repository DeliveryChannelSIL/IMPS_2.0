...
/**
 * D010010 generated by hbm2java
 */
@Entity
@DynamicUpdate
@DynamicInsert
@Table(name = "D010010")
public class D010010 implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -717985783420567062L;
	private D010010Id id;
	...
	public D010010(D010010Id id, Date instrDate, Date stopDate, Date stopTime, Date requestDate, String payeeName,
			double stopAmt, String remarks, byte revokeFlag, Date revokeDate, int dbtrAddMk, int dbtrAddMb,
	...
	@AttributeOverrides({ @AttributeOverride(name = "lbrCode", column = @Column(name = "LBrCode", nullable = false)),
			...
			@AttributeOverride(name = "insNo", column = @Column(name = "InsNo", nullable = false, length = 12)) })
	public D010010Id getId() {
		return this.id;
	}

	public void setId(D010010Id id) {
		this.id = id;
	}
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "StopDate", nullable = false, length = 23)
	...
	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "StopTime", nullable = false, length = 23)
	...
	@Column(name = "PayeeName", nullable = false, length = 35)
	...
	@Column(name = "StopAmt", nullable = false, precision = 53, scale = 0)
	...
	@Column(name = "RevokeFlag", nullable = false)
	public byte getRevokeFlag() {
		return this.revokeFlag;
	}

	public void setRevokeFlag(byte revokeFlag) {
		this.revokeFlag = revokeFlag;
	}

	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "RevokeDate", nullable = false, length = 23)
	...
	public String toString() {
		return "D010010 [id=" + id + ", instrDate=" + instrDate + ", stopDate=" + stopDate + ", stopTime=" + stopTime
				+ ", requestDate=" + requestDate + ", payeeName=" + payeeName + ", stopAmt=" + stopAmt + ", remarks="
				+ remarks + ", revokeFlag=" + revokeFlag + ", revokeDate=" + revokeDate + ", dbtrAddMk=" + dbtrAddMk
				+ ", dbtrAddMb=" + dbtrAddMb + ", dbtrAddMs=" + dbtrAddMs + ", dbtrAddMd=" + dbtrAddMd + ", dbtrAddMt="
				+ dbtrAddMt + ", dbtrAddCk=" + dbtrAddCk + ", dbtrAddCb=" + dbtrAddCb + ", dbtrAddCs=" + dbtrAddCs
				+ ", dbtrAddCd=" + dbtrAddCd + ", dbtrAddCt=" + dbtrAddCt + ", dbtrLupdMk=" + dbtrLupdMk
				+ ", dbtrLupdMb=" + dbtrLupdMb + ", dbtrLupdMs=" + dbtrLupdMs + ", dbtrLupdMd=" + dbtrLupdMd
				+ ", dbtrLupdMt=" + dbtrLupdMt + ", dbtrLupdCk=" + dbtrLupdCk + ", dbtrLupdCb=" + dbtrLupdCb
				+ ", dbtrLupdCs=" + dbtrLupdCs + ", dbtrLupdCd=" + dbtrLupdCd + ", dbtrLupdCt=" + dbtrLupdCt
				+ ", dbtrTauthDone=" + dbtrTauthDone + ", dbtrRecStat=" + dbtrRecStat + ", dbtrAuthDone=" + dbtrAuthDone
				+ ", dbtrAuthNeeded=" + dbtrAuthNeeded + ", dbtrUpdtChkId=" + dbtrUpdtChkId + ", dbtrLhisTrnNo="
				+ dbtrLhisTrnNo + "]";
	}
