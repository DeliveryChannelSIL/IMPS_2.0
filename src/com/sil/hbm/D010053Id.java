...
/**
 * D010053Id generated by hbm2java
 */
@Embeddable
public class D010053Id implements java.io.Serializable {
	private static final long serialVersionUID = -6044892755418423829L;
	private int lbrCode;
	...
	public D010053Id(int lbrCode, String prdAcctId, byte nameType) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof D010053Id))
			return false;
		D010053Id castOther = (D010053Id) other;
		...
		return (this.getLbrCode() == castOther.getLbrCode())
				...
				&& (this.getNameType() == castOther.getNameType());
	}
