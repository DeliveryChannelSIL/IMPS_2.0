...
/**
 * The persistent class for the D020020 database table.
 * 
 */
@Entity
@Table(name = "D020020")
//@NamedQuery(name="D020020.findAll", query="SELECT d FROM D020020 d")
public class TDSMaintananceForTD implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TDSMaintananceForTDId id;
	...
	@Column(name="TrnAmount")
	private double trnAmount;

	@Column(name="ValueDate")
	private Timestamp valueDate;

	public TDSMaintananceForTD() {
	}

	public TDSMaintananceForTDId getId() {
		return this.id;
	}

	public void setId(TDSMaintananceForTDId id) {
		this.id = id;
	}
