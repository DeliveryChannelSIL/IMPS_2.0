package com.sil.hbm;
// Generated Feb 2, 2017 6:31:13 PM by Hibernate Tools 5.2.0.Beta1
...
/**
 * D130003 generated by hbm2java
 */
@Entity
@Table(name = "D130003")
@DynamicUpdate
@DynamicInsert
public class D130003 implements java.io.Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3875449177689550722L;
	private D130003Id id;
	private char chargeType;
	private char skipChrgYn;
	private char allowTodyn;
	private char freqAppln;
	private double minChgAmt;
	private double maxChgAmt;
	private double chqChgAmt;
	private double nonChqChgAmt;
	...
	private byte freeInstances;

	public D130003() {
	}

	public D130003(D130003Id id, char chargeType, char skipChrgYn, char allowTodyn, char freqAppln, double minChgAmt,
			double maxChgAmt, double chqChgAmt, double nonChqChgAmt, String batchCd, String plCrAcctId,
			Date lastApplDate, String lastApplAcctId, char processFlag, String particulars, double minBal,
			double minBalNonChq, int dbtrAddMk, int dbtrAddMb, short dbtrAddMs, Date dbtrAddMd, Date dbtrAddMt,
			...
			byte dbtrAuthDone, byte dbtrAuthNeeded, short dbtrUpdtChkId, int dbtrLhisTrnNo, byte freeInstances) {
		this.id = id;
		this.chargeType = chargeType;
		this.skipChrgYn = skipChrgYn;
		this.allowTodyn = allowTodyn;
		this.freqAppln = freqAppln;
		this.minChgAmt = minChgAmt;
		this.maxChgAmt = maxChgAmt;
		this.chqChgAmt = chqChgAmt;
		this.nonChqChgAmt = nonChqChgAmt;
	...
	public D130003Id getId() {
		return this.id;
	}

	public void setId(D130003Id id) {
		this.id = id;
	}
	...
	@Column(name = "SkipChrgYN", nullable = false, length = 1)
	public char getSkipChrgYn() {
		return this.skipChrgYn;
	}

	public void setSkipChrgYn(char skipChrgYn) {
		this.skipChrgYn = skipChrgYn;
	}
	...
	@Column(name = "FreqAppln", nullable = false, length = 1)
	public char getFreqAppln() {
		return this.freqAppln;
	}

	public void setFreqAppln(char freqAppln) {
		this.freqAppln = freqAppln;
	}
	...
	@Column(name = "ChqChgAmt", nullable = false, precision = 53, scale = 0)
	public double getChqChgAmt() {
		return this.chqChgAmt;
	}

	public void setChqChgAmt(double chqChgAmt) {
		this.chqChgAmt = chqChgAmt;
	}

	@Column(name = "NonChqChgAmt", nullable = false, precision = 53, scale = 0)
	public double getNonChqChgAmt() {
		return this.nonChqChgAmt;
	}

	public void setNonChqChgAmt(double nonChqChgAmt) {
		this.nonChqChgAmt = nonChqChgAmt;
	}
	...
	@Column(name = "FreeInstances", nullable = false)
	public byte getFreeInstances() {
		return this.freeInstances;
	}

	public void setFreeInstances(byte freeInstances) {
		this.freeInstances = freeInstances;
	}
