...
/**
 * D010007 generated by hbm2java
 */
@Entity
@Table(name = "D010007")
@DynamicUpdate
@DynamicInsert
public class D010007 implements java.io.Serializable {
	private static final long serialVersionUID = -3548669381082083547L;

	private D010007Id id;
	private byte dayBeginFlag;
	private byte dayEndFlag;
	private byte daySealedFlag;
	private byte dayReopenFlag;
	private byte dayEndStage;
	...
	public D010007(D010007Id id, byte dayBeginFlag, byte dayEndFlag, byte daySealedFlag, byte dayReopenFlag,
			byte dayEndStage, int dbtrAddMk, int dbtrAddMb, short dbtrAddMs, Date dbtrAddMd, Date dbtrAddMt,
		...
		this.daySealedFlag = daySealedFlag;
		this.dayReopenFlag = dayReopenFlag;
		this.dayEndStage = dayEndStage;
	...
	@AttributeOverrides({ @AttributeOverride(name = "lbrCode", column = @Column(name = "LBrCode", nullable = false)),
			@AttributeOverride(name = "dyfDate", column = @Column(name = "DyfDate", nullable = false, length = 23)) })
	public D010007Id getId() {
		return this.id;
	}

	public void setId(D010007Id id) {
		this.id = id;
	}

	@Column(name = "DayBeginFlag", nullable = false)
	public byte getDayBeginFlag() {
		return this.dayBeginFlag;
	}

	public void setDayBeginFlag(byte dayBeginFlag) {
		this.dayBeginFlag = dayBeginFlag;
	}

	@Column(name = "DayEndFlag", nullable = false)
	public byte getDayEndFlag() {
		return this.dayEndFlag;
	}

	public void setDayEndFlag(byte dayEndFlag) {
		this.dayEndFlag = dayEndFlag;
	}

	@Column(name = "DaySealedFlag", nullable = false)
	public byte getDaySealedFlag() {
		return this.daySealedFlag;
	}

	public void setDaySealedFlag(byte daySealedFlag) {
		this.daySealedFlag = daySealedFlag;
	}

	@Column(name = "DayReopenFlag", nullable = false)
	public byte getDayReopenFlag() {
		return this.dayReopenFlag;
	}

	public void setDayReopenFlag(byte dayReopenFlag) {
		this.dayReopenFlag = dayReopenFlag;
	}

	@Column(name = "DayEndStage", nullable = false)
	public byte getDayEndStage() {
		return this.dayEndStage;
	}

	public void setDayEndStage(byte dayEndStage) {
		this.dayEndStage = dayEndStage;
	}
