...
public class VoucherRecharge {
	public	static org.apache.log4j.Logger logger=org.apache.log4j.Logger.getLogger(VoucherRecharge.class);
...
//				sessionDebit.close();
	...
	public boolean creditABB(String prdAcctId, int slbrCode,int tlbrCode,  double amt, String actType, String transType, String instrNo, String particulars, long setNo, long scrollNo){
		...
		try {
			...
			if(txCredit != null) txCredit.rollback();
			return false;
		}		
	...
	public boolean credit(String prdAcctId, int lbrCode, double amt, String actType, String transType, String instrNo, String particulars, long setNo, long scrollNo){
		...
		try {
			...
			sessionCredit=HBUtil.getSessionFactory().openSession();
			Transaction txDebit1=sessionCredit.beginTransaction();		
			try {
				sessionCredit.save(d40);
				txCredit.commit();
				//				sessionDebit1.flush();	
				sessionCredit.close();
				return true;		
